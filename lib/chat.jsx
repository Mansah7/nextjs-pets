...
export default function Chat() {
    ...
    const [isChapOpen, setIsChatOpen] = useState(false)
    ...
    return (
        <>
            ...
            <div className="open-chat" onClick={openChatClick}>
                {unreadCount > 0 && <span className="chat-unread_badge">{unreadCount}</span>}
            ...
            <div className={isChapOpen ? "chat-container chat-container--visible" : "chat-container"}>
                ...
                <form onSubmit={handleChatSumit}>
                <input value={userMessage} ref={chatField} onChange={handleInputChnage} type="text" autoComplete="off" placeholder="Your message here" />
                </form>
            </div>
        </>
    )
